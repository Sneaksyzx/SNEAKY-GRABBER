...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Sneaky Grabber Builder")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Sneaky Grabber Builder", image=self.logo_image,
